...
RUN apt-get update && apt-get install -y --no-install-recommends m2ee-tools openjdk-7-jre-headless postgresql-client procps vim-nox curl oracle-java8u45-jre && apt-get clean
